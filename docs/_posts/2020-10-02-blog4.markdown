...
li.navbar a:hover {<br>
  ...
  transition: all 0.4s ease;<br>
      ...
      </dd><b>Step 3 - Social Media Navigation </b></dt>
...
<p>Here is an image of the finished header section with and without the css:
      <center>
    <b>Without CSS</b>
...
In order to get a complete view of the website and to see how the navigations and header image work, visit my site at <a href="https://davidwebsite2.glitch.me">Davis's Sports Blog!</a>
   </p>
<h2>Next steps</h2>
