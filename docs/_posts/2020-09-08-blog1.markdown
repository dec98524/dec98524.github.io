...
<p>After I got familiar with a few of the Docker commands, the next step was to install Apache.    
...
<p> In order to install Apache, and to check the version, type these commands into the command line on your terminal: <br>
